...
static const QStringList DirectoryX = QStandardPaths::standardLocations(QStandardPaths::HomeLocation);
static const QString CacheFolder = DirectoryX.first() + "/.cache/deepin/deepin-notifications/";
